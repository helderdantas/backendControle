...
CREATE TABLE IF NOT EXISTS "controles" (
	...
	"ilha" VARCHAR(255) NOT NULL,
	"baia" VARCHAR(255) NOT NULL,
	"cputombo" VARCHAR(255) NOT NULL,
	"cpunumeroserie" VARCHAR(255) NOT NULL,
	"monitor1tombo" VARCHAR(255) NOT NULL,
	"monitor1numeroserie" VARCHAR(255) NOT NULL,
	"monitor2tombo" VARCHAR(255) NOT NULL,
	"monitor2numeroserie" VARCHAR(255) NOT NULL,
